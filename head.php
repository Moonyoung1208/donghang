...
<div id="hd">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const firstDepthItems = document.querySelectorAll("#gnb .gnb_1dli > a");
            ...
            // 1depth 클릭 → 아코디언
            firstDepthItems.forEach((link) => {
                link.addEventListener("click", (e) => {
                    // 하위 메뉴가 있는 경우만 아코디언 작동
                    const parent = link.parentElement;
                    const submenu = parent.querySelector(".gnb_2dul");
                    ...
                    if (submenu) {
                        ...
                        if (parent.classList.contains("open")) {
                            ...
                            // 다른 메뉴 닫기
                            document.querySelectorAll("#gnb .gnb_1dli.open").forEach((li) => {
